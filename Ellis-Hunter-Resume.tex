...
\begin{document}
    ...
    \begin{twocolentry}{{Aug 2023 -- Present} \\\textit{Blacksburg, Virginia}}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Undergraduate and graduate research developing neuro-symbolic reinforcement learning algorithms with \hrefWithoutArrow{https://coolautonomylab.github.io/}{The Control, Optimization, and Online Learning for Autonomy Lab (C.O.O.L.) at UT Austin.}
