...
\begin{document}
    ...
    $\hookrightarrow$ Currently working on my thesis in an Accelerated Master's Program at Virginia Tech.\hfill\hrefWithoutArrow{https://ellishw.tech}{{ellishw.tech}}\\
    ...
    \kern 5.0 pt%
    \textbf{Hardware: }SMD Soldering, PCB Design and Assembly,  Oscilloscope, Multimeter, 3D-Printing\\ 
    \section{Education}
    ...
    \begin{twocolentry}{{Aug 2024 -- Present} \\\textit{Blacksburg, Virginia}}
        ...
        \textbf{\textit{Virginia Tech \boldmath$\cdot$ Teaching Assistant}}\\
        \begin{onecolentry}
            \begin{highlights}
...
\begin{twocolentry}{{May 2024 -- Aug 2024} \\\textit{Huntsville, Alabama \\ (Merrit Island, Florida)}}
    ...
    \begin{twocolentry}{{June 2022 -- Aug 2022}\\\textit{West Bethesda, Maryland}}
        ...
        \begin{onecolentry}
            \begin{highlights}
            \item Developed concept hospital sea-train design at the Center for Innovation in Ship Design
