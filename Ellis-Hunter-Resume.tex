...
\begin{document}
    ...
    \begin{twocolentry}{{Aug 2023 -- Present} \\\textit{Blacksburg, Virginia}}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Developing a 6-axis robotic manipulator and a ROS2–based simulation environment using Gazebo and Gymnasium for testing custom reinforcement learning algorithms.
                \item Undergraduate and graduate research applying "neuro-symbolic" reinforcement learning algorithms with \hrefWithoutArrow{https://coolautonomylab.github.io/}{The Control, Optimization, and Online Learning for Autonomy Lab (C.O.O.L.) at UT Austin.}
            \end{highlights}
        \end{onecolentry}
    \end{twocolentry}
