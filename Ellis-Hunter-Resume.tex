...
\begin{document}
    ...
    \begin{twocolentry}{{Aug 2023 -- Present} \\\textit{Blacksburg, Virginia}}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Undergraduate and graduate research developing neuro-symbolic algorithms with \hrefWithoutArrow{https://coolautonomylab.github.io/}{The C.O.O.L Autonomy Lab at The University of Texas at Austin.}
...
\begin{twocolentry}{{May 2024 -- Aug 2024} \\\textit{Huntsville, Alabama \\ (Merrit Island, Florida)}}
    ...
    \textbf{\textit{Jacobs Space Exploration Group \boldmath$\cdot$ TVC Intern}}\\
        \begin{onecolentry}
            \begin{highlights}
            \item Developed thrust vector control testing hardware and software as part of NASA's Active Inertial Load Simuator at the Marshall Space Flight Center.
            \item Characterized and created a model of an electro-mechanical actuator including internal viscous and (non-linear) coloumb friction components.
            \item Derived control systems for load simulating actuators -- used to simulate external loads placed on the Mars Ascent Vehicle's thrust vector control actuators during flight. 
    ...
    \begin{twocolentry}{{June 2023 -- Aug 2023}\\ \textit{Grenoble, France}}
        ...
        \begin{onecolentry}
            \begin{highlights}
            \item Researched inverter control systems -- designed to be robust to islanding events and avoid future infastructure problems on the French power grid.
